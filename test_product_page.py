...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.open()
    page.should_be_promo_param_in_link()
    page.add_to_basket()
    page.solve_quiz_and_get_code()
    page.should_be_addition_to_basket_message()
    page.should_be_correct_total_cost()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.should_not_be_product_in_empty_basket()
